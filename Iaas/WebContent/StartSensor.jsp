		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="userDashBoard.jsp"><i class="fa fa-desktop "></i>Dashboard
					</a></li>
					...
					<table id="tableId">
						<thead>
							<tr>
								...
								<td><b>Location</b></td>
								<td><b> <i class="material-icons button edit"
										onclick="myStart()">play_circle_filled</i></b></td>
							</tr>
						</thead>
							...
							<c:forEach items="${userSensorList}" var="sensor"
								...
								<tr>
									...
									<td><i class="material-icons button edit"
										onclick="myStart(this)">play_circle_filled</i></td>
								</tr>
							</c:forEach>
