				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="alert alert-info">
							<strong>Welcome User ! </strong> You Have No pending Task For
							Today.
						</div>
				...
				<div class="row text-center pad-top">
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="createSensor.jsp"> <i class="fa fa-circle-o-notch fa-5x"></i>
								<h4>Create Sensor</h4>
							</a>
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="<%=request.getContextPath()%>/viewSensors"> <i class="fa fa-circle-o-notch fa-5x"></i>
								<h4>View Sensors</h4>
							</a>
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="<%=request.getContextPath()%>/startSensor"> <i class="fa fa-circle-o-notch fa-5x"></i>
								<h4>Start Sensor</h4>
							</a>
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="<%=request.getContextPath()%>/stopSensor"> <i class="fa fa-circle-o-notch fa-5x"></i>
								<h4>Stop Sensor</h4>
							</a>
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="<%=request.getContextPath()%>/terminateSensor"> <i class="fa fa-circle-o-notch fa-5x"></i>
								<h4>Delete Sensor</h4>
							</a>
						</div>
					</div>
